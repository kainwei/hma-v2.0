 ...
 *
 */
public class DoubleCyclesSingleLongRateGreaterThanOrEqualToAnomalyDetector extends
	 ...
	 * @param threshold
	 */
	public DoubleCyclesSingleLongRateGreaterThanOrEqualToAnomalyDetector(
			String monitorItemName, long threshold) {
